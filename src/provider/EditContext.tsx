...
<body x-data="global()" x-init="themeInit()" :class="isMobileMenuOpen ? 'max-h-screen overflow-hidden relative' : ''" class="dark:bg-primary">
    <div class="flex items-center justify-center p-2" style="background-color: #3093ff">
        <img src="/assets/img/logo-r.svg" alt="red pixel themes logo" class="mr-4 h-7 w-auto md:h-10">
        <p class="w-auto font-body text-xs font-bold text-white md:text-xl">
            Like what you see? You can download it
            <a class="inline-block text-white underline" href="https://redpixelthemes.com/templates/atlas/" target="_blank">here</a>
        </p>
    </div>
    <div id="main">
          ...
          <span href="/" class="mr-2">
            <img src="/assets/img/logo.svg" alt="logo">
                ...
                <div class="flex items-center lg:hidden">
                    <i class="bx mr-8 cursor-pointer text-3xl text-primary dark:text-white bxs-moon" @click="themeSwitch()" :class="isDarkMode ? 'bxs-sun' : 'bxs-moon'"></i>
                ...
                <div class="hidden lg:block">
                    <ul class="flex items-center">
                        ...
                        <li>
                            <i class="bx cursor-pointer text-3xl text-primary dark:text-white bxs-moon" @click="themeSwitch()" :class="isDarkMode ? 'bxs-sun' : 'bxs-moon'"></i>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div><div class="container mx-auto">
            <div class="border-b border-grey-lighter py-16 lg:py-20">
                ...
                <h1 class="title-set pt-3 font-body text-4xl font-semibold text-primary dark:text-white md:text-5xl lg:text-6xl">
                    Hi, I’m John Doe.
                </h1>
...
const EditorProvider: React.FC<EditorProviderProps> = ({ children }) => {
    const [html, setHtml] = useState(html_text);
